...
public class ImageController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<String[]> profileImage(@RequestParam MultipartFile file) throws IOException {
        return new ResponseEntity(imageUploader.uploadImage(file), null, 200);
    }
/*
